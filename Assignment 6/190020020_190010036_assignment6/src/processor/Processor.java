...
public class Processor {
	...
	public Processor()
	{
		...
		L1dCache = new Cache(8);
		L1iCache = new Cache(128);
		...
		IFUnit = new InstructionFetch(this, IF_EnableLatch, IF_OF_Latch, EX_IF_Latch, L1iCache);
		...
		MAUnit = new MemoryAccess(this, EX_MA_Latch, MA_RW_Latch, L1dCache);
