...
public class Execute implements Element {
    ...
    public void performEX() {
        ...
        if (OF_EX_Latch.isEX_enable()) {
            ...
            if (opcode_str.equals("11000")) {
                System.out.println("No latency");
            } else if (opcode_str.equals("00100") || opcode_str.equals("00101")) {    // multi
            ...
            } else if (opcode_str.equals("00110") || opcode_str.equals("00111")) {    // div
                Simulator.getEventQueue().addEvent(
                        new AluEvent(
